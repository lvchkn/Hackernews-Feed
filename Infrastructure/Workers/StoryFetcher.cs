...
public class StoryFetcher : BackgroundService
{
    ...
    public StoryFetcher(IServiceScopeFactory scopeFactory,
    ...
    {
        _logger.LogInformation("Story fetcher executing");
        ...
        consumer.ReceivedAsync += async (_, eventArgs) =>
        {
            ...
            var story = JsonSerializer.Deserialize<StoryDto>(message, _jsonSerializerOptions);
            ...
            if (story is not null)
            {
                ...
                _logger.LogInformation("Message saved: {Story}", story.ToString());
            }
